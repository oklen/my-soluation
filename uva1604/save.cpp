...
//    maxd = in>>27;return;
//  }
//  if(fin&&rused.count(0x7ffffff&in))
//  {
////      cout << "use double search:"<<(in>>27) <<endl;
//      maxd = (in>>27)+10;return;
//  }
//  int px,py;
//  for(int i = 0;i<9;++i)
//    {
...
//              midresult.push(*bb);
//          int ss = midresult.size()*3/4;
//          for(int i = 0;i<ss;++i) midresult.pop();
//          while(!midresult.empty()) rbfs();
//          while(!result.empty())result.pop();used.clear();
//          maxd= -1;result.push(gc);
//          while (maxd==-1) {
//              bfs();
//          }
//      }
